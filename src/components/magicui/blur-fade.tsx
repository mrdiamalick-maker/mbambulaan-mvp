...
// Magic UI — Blur Fade (sourcé via github.com/magicuidesign/magicui, voir
// number-ticker.tsx). Validé par le CEO pour une apparition douce au
// scroll — discrète, jamais un effet ludique.
