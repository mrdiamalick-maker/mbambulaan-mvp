...
export const ecosystemProfiles: Record<RoleKey, EcosystemProfile> = {
  ...
  ong: {
    ...
    capabilities: [
      ...
      { title: "Beneficiaires", metric: "246 suivis", description: "Regroupe relais, organisations et acteurs appuyés.", tone: "blue" },
  ...
  pecheur: {
    ...
    mapSubtitle: "Un pecheur ne voit pas un centre dense: il voit son signal, son relais et la prochaine etape.",
    capabilities: [
...
export const privateSpaceConfigs: PrivateSpaceConfig[] = [
  {
    key: "etat",
    title: "Espace de pilotage institutionnel",
    organization: "Ministere des Peches",
    roleLabel: "Etat / Ministere",
    territoryDefault: "Joal",
    accent: "blue",
    topbarCta: "Generer note ministerielle",
    sidebar: ["Synthese nationale", "Carte des quais", "Territoires", "Tensions", "Programmes", "Financements", "Notes", "Preuves"],
  ...
  },
  {
    ...
    sidebar: ["Vue programme", "Zones", "Beneficiaires", "Actions terrain", "Preuves", "Risques", "Reporting", "Budget"],
  ...
  },
  {
    ...
    sidebar: ["Commune", "Carte locale", "Quais", "Demandes", "Urgences", "Partenaires", "Actions", "Note mairie"],
  ...
  },
  {
    ...
    sidebar: ["Pipeline supply", "Carte supply", "Opportunites privees", "Preuves", "Risques", "Conditions", "Decision memo"],
  ...
  },
  {
    ...
    sidebar: ["Bureau", "Membres", "Demandes collectives", "Carte membres", "Dossiers partenaires", "Preuves", "Plaidoyer"],
  ...
  },
  {
    ...
    sidebar: ["These", "Segments payeurs", "Offres", "Pipeline", "Carte expansion", "Revenus", "Roadmap", "Risques", "Data room"],
