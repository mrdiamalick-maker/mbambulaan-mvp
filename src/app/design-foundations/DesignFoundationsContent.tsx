...
//
// XXL-R2 (§0, micro-correctif) — le contenu proprement dit reste un
// composant client (interactions légères, aucune donnée serveur), mais
// n'est plus exporté comme page directement : page.tsx (server component,
// même dossier) décide s'il doit être rendu du tout, cf. commentaire
// là-bas pour la garde d'accès réelle.
import {
  PageIntro,
  EditorialSection,
  MetricStatement,
...
export function DesignFoundationsContent() {
  return (
