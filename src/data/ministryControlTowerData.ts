...
export const pirogues: Pirogue[] = [
  { id: "pir-101", registration: "DK-PI-2041", quayId: "joal", status: "Retour déclaré", lastPosition: "Petite-Côte", lastDeclaration: "10:12", declaredActivity: "Débarquement de sardinelle", x: 62, y: 69, level: "normal" },
  { id: "pir-102", registration: "SL-PI-1188", quayId: "saint-louis", status: "À vérifier", lastPosition: "Large de Saint-Louis", lastDeclaration: "08:55", declaredActivity: "Retour non confirmé", x: 30, y: 13, level: "urgent" },
  { id: "pir-103", registration: "TH-PI-0772", quayId: "kayar", status: "À surveiller", lastPosition: "Nord Kayar", lastDeclaration: "09:18", declaredActivity: "Trajectoire inhabituelle", x: 52, y: 38, level: "surveillance" },
  { id: "pir-104", registration: "ZG-PI-4510", quayId: "kafountine", status: "Retour attendu", lastPosition: "Casamance maritime", lastDeclaration: "09:45", declaredActivity: "Pêche crevettes", x: 24, y: 90, level: "normal" },
  { id: "pir-105", registration: "MB-PI-3307", quayId: "mbour", status: "Actif", lastPosition: "Mbour Sud", lastDeclaration: "10:06", declaredActivity: "Débarquement poulpe", x: 63, y: 60, level: "normal" },
  { id: "pir-106", registration: "FB-PI-2214", quayId: "fass-boye", status: "Départ à confirmer", lastPosition: "Fass Boye", lastDeclaration: "08:40", declaredActivity: "Départ groupé signalé", x: 47, y: 34, level: "surveillance" }
];
