# Mbàmbulaan – Working Product Brief

Ce document est le cahier des charges maître pour Working.
...
- Intégrer SMS, téléphone, WhatsApp Business, notifications, email selon les cas d'usage.
- Ajouter exports PDF, Excel, rapports institutionnels et tableaux de bord.
- Construire des jeux de données réalistes couvrant tout le littoral sénégalais (territoires, quais, débarquements, pirogues, situations, besoins, marchés, financements, organisations, acteurs, infrastructures, initiatives).
- Renforcer la partie publique : vision, filière, actualités, annonces, atlas, communautés, durabilité, partenaires, contenus pédagogiques.
- Finaliser le modèle d'abonnements, modules Premium, droits, capacités et monétisation.
