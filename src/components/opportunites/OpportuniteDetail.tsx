...
export function OpportuniteDetail({ opportunite }: { opportunite: Opportunite }) {
  ...
  function reserveOpportunity() {
    ...
    setSuccessMessage("Coordination lancée : transaction créée au statut Réservée.");
  }
  ...
  function advanceTransaction() {
    ...
    setSuccessMessage(`Transaction mise à jour : ${nextStatus}.`);
  }
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="mt-8 rounded-3xl bg-white p-6 shadow-sm ring-1 ring-[#14312d]/10 sm:p-10">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <p className="text-sm font-black uppercase tracking-[0.18em] text-[#d65a31]">Détail opportunité</p>
              ...
              <p className="mt-5 max-w-3xl text-lg leading-8 text-[#14312d]/70">
                Fiche de coordination entre un besoin d'achat, un arrivage compatible, les acteurs concernés, la qualité du lot et la preuve de décision.
              </p>
            </div>
            <div className="rounded-3xl bg-[#f7f4ec] p-6 lg:min-w-80">
              <p className="text-sm font-black uppercase tracking-[0.14em] text-[#d65a31]">Compatibilité</p>
          ...
          {successMessage ? (
            ...
            <div className="mt-8 rounded-2xl bg-[#d8f3dc] px-5 py-4 text-sm font-black text-[#1b5e20] ring-1 ring-[#95d5b2]">
              Réservation confirmée. Cette opportunité n'est plus proposée comme disponible.
            </div>
          ) : null}

          <div className="mt-8 grid gap-4 lg:grid-cols-2">
            <InfoPanel title="Informations de l'offre">
              <DetailLine label="Acteur concerné" value={opportunite.offre.vendeur} />
              <DetailLine label="Espèce" value={opportunite.espece} />
              <DetailLine label="Quantité disponible" value={opportunite.offre.quantite} />
              <DetailLine label="Lieu" value={opportunite.offre.quai} />
              <DetailLine label="Heure de débarquement" value={opportunite.offre.heureDebarquement} />
            ...
            <InfoPanel title="Informations du besoin">
              ...
              <DetailLine label="Espèce recherchée" value={opportunite.espece} />
              <DetailLine label="Quantité demandée" value={opportunite.besoin.quantite} />
          ...
          <div className="mt-8 rounded-3xl border border-[#14312d]/10 p-6">
            <p className="text-sm font-black uppercase tracking-[0.18em] text-[#d65a31]">Acteurs concernés</p>
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <ActorCard actor={acheteurTrust} label="Demandeur" title="Score de confiance de l'acheteur" />
              <ActorCard actor={vendeurTrust} label="Acteur concerné" title="Score de confiance du vendeur" />
            </div>
          </div>
