...
export default async function FinancementJourneyPage({ searchParams }: PageProps) {
  ...
  return <EtatParcoursWorkbench kind="financement" initialRegion={(region ?? "Tout") as MinistryRegionName} initialQuayId={quai ?? "th-joal"} />;
}
