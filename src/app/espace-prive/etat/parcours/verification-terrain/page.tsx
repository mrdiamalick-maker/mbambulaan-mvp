...
export default async function VerificationTerrainJourneyPage({ searchParams }: PageProps) {
  ...
  return <EtatParcoursWorkbench kind="verification-terrain" initialRegion={(region ?? "Tout") as MinistryRegionName} initialQuayId={quai ?? "th-joal"} />;
}
