    ...
    <main className="pub-scope min-h-screen">
      ...
      <section className="mx-auto max-w-[1500px] px-5 py-14 md:px-10 md:py-20">
        ...
        <section id="valeur-immediate" className="mt-16 scroll-mt-24">
          ...
          <div className="mt-6 rounded-[var(--pub-radius-md)] border border-[var(--pub-stone-150)] bg-[var(--pub-ivory-100)] p-5"><p className="text-sm leading-6 text-[var(--pub-stone-700)]">Les outils professionnels viendront renforcer cette infrastructure avec des workflows et espaces adaptés aux organisations qui opèrent quotidiennement dans la filière, à mesure que les usages réels le justifieront.</p></div>
        </section>
