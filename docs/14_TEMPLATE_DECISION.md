...
Mosaic : très bon choix premium sobre. À garder si TailAdmin paraît trop générique.

Metronic : très puissant mais plus lourd. À garder pour une version plus mature ou si TailAdmin ne suffit pas.

Materio : solide mais moins naturel pour le repo actuel car basé sur Material UI.

Tremor + shadcn custom : très flexible mais demande plus d'effort design.
...
- Les dashboards devront être transformés en espaces métier, pas copiés tels quels.
...
Objectif : reconstruire proprement les routes publiques, les démos par rôle, les formulaires et l'espace premium simulé.

## Critère de validation finale

TailAdmin est confirmé seulement si la revue visuelle montre que l'on peut produire un rendu premium, institutionnel et crédible pour ministère, ONG, collectivité, entreprise, exportateur et investisseur.
