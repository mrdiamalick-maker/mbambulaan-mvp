...
export function ContextPanel({ title, subtitle, level, trustLevel, rows, actions, trend, pirogue, referents, empty = false }: { title: string; subtitle: string; level?: Level; trustLevel?: DataTrustLevel; rows: Array<[string, string]>; actions: Array<{ label: string; helper?: string; primary?: boolean; onClick: () => void }>; trend?: number[]; pirogue?: Pirogue | null; referents?: ReactNode; empty?: boolean }) {
