import { PremiumCoordinationPage } from "@/components/premium/PremiumExperience";
...
export default function CoordinationPage() {
  ...
  return <PremiumCoordinationPage slice={computeCoordinationEngine()} dashboardData={computeDashboardMetrics(arrivages, besoins, opportunites)} />;
}
