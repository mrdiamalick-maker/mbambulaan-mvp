...
export function PublicContactForm() {
  ...
  return <form onSubmit={prepareRequest} className="border border-[var(--mb-neutral-200)] bg-white p-5 sm:p-7">
    ...
    <button type="submit" className="mt-6 inline-flex h-11 w-full items-center justify-center rounded-[3px] bg-[var(--mb-navy-700)] px-5 text-[11px] font-bold text-white hover:bg-[var(--mb-navy-900)] sm:w-auto">Préparer la prise de contact</button>
