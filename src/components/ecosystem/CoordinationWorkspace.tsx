      ...
      <section className="surface overflow-hidden">
        ...
        {view === "rapprochements" && <div className="grid gap-px bg-[#d9e3e3] md:grid-cols-2">{state.opportunities.length ? state.opportunities.map((opportunity) => {
          ...
          return <article key={opportunity.id} className="bg-white p-5 lg:p-6">
            <div className="flex items-start justify-between gap-4"><div><p className="text-[10px] font-black uppercase tracking-[.1em] text-[#08758a]">{territory?.name} · à valider</p><h3 className="mt-2 text-lg font-black">{species?.name} · {need?.quantityKg} kg</h3></div><span className="text-3xl font-black tracking-[-.05em] text-[#075568]">{opportunity.score}%</span></div>
