...
const links = [
  ...
  { href: "/decouvrir#programmes", label: "Programmes", compactLabel: "Programmes" },
  { href: "/contact", label: "Nous contacter", compactLabel: "Contact" },
  ...
  return <header className="border-b border-[var(--mb-neutral-200)] bg-white">
    <div className="mx-auto flex max-w-[84rem] flex-wrap items-center justify-between gap-3 px-5 py-3 sm:px-8 lg:px-10">
      <Link href="/" className="flex items-center gap-3" aria-label="Accueil Mbàmbulaan">
        ...
        <span><strong className="block text-[15px] text-[var(--mb-navy-900)]">Mbàmbulaan</strong><span className="text-[9px] font-bold uppercase tracking-[0.1em] text-[var(--mb-neutral-400)]">Pêche artisanale sénégalaise</span></span>
      </Link>
