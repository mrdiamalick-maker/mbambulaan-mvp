            ...
            <article className="surface overflow-hidden" key={initiative.id}>
              <div className="border-b border-[#d8e1e2] bg-[#fcfaf4] p-5 lg:p-6">
                <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                  <div><p className="label">Portefeuille chaîne du froid</p><h2 className="mt-2 max-w-3xl text-xl font-bold text-[#062d36]">{initiative.title}</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-[#60737a]">{initiative.objective}</p></div>
