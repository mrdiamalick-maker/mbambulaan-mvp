  ...
  return (
    <div className="shadcn-scope space-y-6 bg-background p-5 pb-16 lg:p-8">
      <div>
        ...
        {/* XXL-RC1 (§5.C) — mb-page-title (display serif partagé Landing/
            Public/État/Aujourd'hui/Programmes), même discipline modérée :
            seul ce titre de page, pas les sous-titres de section. */}
        <h1 className="mb-page-title mt-2">Organisation &amp; réseau</h1>
