...
export default async function CoordinationJourneyPage({ searchParams }: PageProps) {
  ...
  return <EtatParcoursWorkbench kind="coordination" initialRegion={(region ?? "Tout") as MinistryRegionName} initialQuayId={quai ?? "th-joal"} />;
}
